package com.github.novinity.dementedcreeper.entity.animations;
...
public class ModAnimationDefinitions {
    public static final AnimationDefinition DEMENTED_CREEPER_WALK = AnimationDefinition.Builder.withLength(1.0F).looping()
    ...
    public static final AnimationDefinition DEMENTED_CREEPER_IDLE = AnimationDefinition.Builder.withLength(2.0833F).looping()
            .addAnimation("upperbody", new AnimationChannel(AnimationChannel.Targets.ROTATION,
